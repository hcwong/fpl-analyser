...
async def is_gameweek_valid(gameweek_int):
    current_gw = await get_current_gameweek()
    return gameweek_int >= MIN_GAMEWEEK and gameweek_int <= MAX_GAMEWEEK and gameweek_int <= current_gw
...
async def get_player_gameweek_interval(user_entry, start_gameweek_int, end_gameweek_int):
